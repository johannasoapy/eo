										...
										<?php if( get_field('workshop_synchronous') ): ?>
                                            ...
                                            <?php endif; ?>
												...
												<?php wp_reset_postdata(); // IMPORTANT - reset the $post object so the rest of the page works correctly ?>
                                                    ...
                                                    echo $eventDate;
                                                        $id = get_the_ID();
                                                        if ( ! add_post_meta( $id, 'workshop_current', $eventDate, true ) ) { 
                                                           update_post_meta( $id, 'workshop_current', $eventDate );
                                                        }
                                                    $current = get_metadata('post', $id, 'workshop_current', $single);
                                                    echo $current; ?>
...
<!------------------------------end Synchronous session---------------------------------------------------> 
						...
						<?php else : ?>
								...
								<article id="post-not-found" class="hentry cf">
									...
									<footer class="article-footer">
										<p><?php _e( 'This is the error message in the single-sfwd-topic.php template.', 'bonestheme' ); ?></p>
									</footer>
								</article>

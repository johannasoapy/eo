<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
					...
					<main id="main" class="m-all t-3of4 d-3of4 last-col cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
							...
							<?php if ( is_tax( 'learning_options' ) ) { ?>
							...
							<?php
								...
								$archive_args = array(
								  'post_type' => array('post','sfwd-lessons','sfwd-courses','tribe_events'  ),
								  'learning_options' => $tax->slug,
								  'posts_per_page' => '20',
								  'paged' => $paged
								);
     ...
     <?php                                               
echo 'hello';
$terms = get_the_terms( $post->ID , 'learning_options' );
foreach ( $terms as $term ) {

    // We successfully got a link. Print it out.
    echo '<li><a href="' . home_url() . '/learn/' . $term->slug . '">' . $term->name . '</a></li>';
}
...
?>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry cf">
										...
										<section class="entry-content">
											<p><?php _e( 'Sorry, try another category or tag.', 'bonestheme' ); ?></p>
										</section>
										<footer class="article-footer">
												<p><?php _e( 'This learning option archive is empty.', 'bonestheme' ); ?></p>
										</footer>
									</article>
